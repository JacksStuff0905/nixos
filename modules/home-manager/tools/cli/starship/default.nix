    ...
    elements = {
      ...
      character = {
        ...
        success = lib.mkOption {
          type = lib.types.str;
          default = "[](bold fg:success_color)";
        };
        error = lib.mkOption {
          type = lib.types.str;
          default = "[](bold fg:error_color)";
        };
        vimcmd = {
          symbol = lib.mkOption {
            type = lib.types.str;
          ...
          replace-one = lib.mkOption {
            type = lib.types.str;
            default = "[R](bold fg:replace_color)";
          };
          replace = lib.mkOption {
            type = lib.types.str;
            default = "[C](bold fg:replace_color)";
          };
          visual = lib.mkOption {
            type = lib.types.str;
            default = "[V](bold fg:bg_color2)";
          };
        };
      };
    };
